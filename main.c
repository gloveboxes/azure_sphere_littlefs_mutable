...
#define TOTAL_BLOCKS   256     // TODO: Modify TOTAL_BLOCKS to match your SD Card configuration (total bytes/512)
...
static int storage_write(const struct lfs_config* c, lfs_block_t block, lfs_off_t off, const void* buffer, lfs_size_t size);
